...
subtitle: "Snapshot Report : August 2020"
...
```{r provincial plots 2, include = TRUE, echo= FALSE, fig.align="left", fig.height=3, fig.width = 8}
y.lim.max <- 50
...
* The red dashed line on the graph above indicates the 7 month data validation target. 

```{r provincial plots 3, include = TRUE, echo= FALSE, fig.align="left", fig.height= 3, fig.width = 8}
...
```{r months over time plot ,  include = TRUE, echo= FALSE, fig.align="leftr"  }
...
p4 <- ggplot(graded_data, aes(report_date, 100 - pc.gth.7, color = Region, fill = Region)) +
  geom_col(position = "dodge") +
  scale_x_date(breaks = date.ticks, date_labels = "%b-%y")+
  ylab("%") +
  xlab("") +
...
*This assessment was completed July 7 and 8, 2020 and is current as of this date.
